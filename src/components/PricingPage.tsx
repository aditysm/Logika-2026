...
export function PricingPage({
  ...
  const getProgressSpecs = () => {
    switch (currentTier) {
      ...
      case 'basic':
        return { percent: 'w-2/3', text: 'Tingkat akses Anda: Paket Basic. Tinggal 1 langkah lagi untuk membuka fitur pembuatan laporan Word.' };
      default:
  ...
  const comparisonFeatures = [
    ...
    {
      name: 'Membuat berkas dokumen Laporan Word (.docx) otomatis',
      free: false,
      basic: false,
      pro: true,
    },
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className={`bg-white border rounded-2xl p-6 flex flex-col justify-between relative shadow-2xs transition-all ${
          ...
          <div className="space-y-4">
            ...
            <p className="text-[11px] text-slate-500">Mencakup semua fitur, ditambah pembuatan laporan Word (.docx) &amp; dokumen otomatis.</p>
